...
def get_station_data(df, TrainStations):
    ...
    for index, stop in df.iterrows():
        ...
        if waitTime == -1 or waitTime > bunchThreshold:
...
data_loop_2('media/initial_data_20251116_100609.json', 'media/diffs_20251116_100609.json', 'bunched_station_data_2.csv') 